...
[![Tests](https://img.shields.io/badge/tests-1478%20passing-success)](#)
...
**1,478 tests** cover the damage formula across all generations of items / abilities / Tera / weather / multi-hit interactions, plus end-to-end MCP tool registration and production-bug regression tests for known-tricky interactions (Sword of Ruin + crits, Sheer Force + Life Orb, Ogerpon mask routing).
...
- ✅ 208 tools registered, 1,478 tests passing
